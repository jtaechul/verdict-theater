...
def main():
    ...
    for m in parts:
        ...
        # ⚠️⚠️⚠️ 2026-09-09 — **되돌렸다. 이 채널의 숫자가 그렇게 말한다.**
        #    9/06 에 내가 "유튜브는 세로 9:16 으로 쇼츠를 스스로 알아보니
        #    제목의 #shorts 는 하는 일이 없다" 며 뺐다. 그런데 실측은 반대였다:
        #        있음 9편 353~3,576회 · 없음 3편 46~220회 · 겹치는 구간 없음
        #    뺀 뒤 올린 세 편이 46·72·220 으로 무너졌다.
        ck(f"{no}편 제목에 #shorts 가 붙는다",
           "#shorts" in m["title"].lower(), m["title"])
