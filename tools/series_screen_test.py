...
# ⭐⭐ 2026-08-24 — 카메라 자리 지시도 반드시 남아야 한다. 이게 빠지면
#    마주보는 두 사람 뒤에 **같은 벽**이 나온다(운영자 신고).
_nocam2 = [k for k, v in lumina.items() if "CAMERA:" not in v]
ck("복사되는 글에 **카메라 자리** 지시가 들어 있다", not _nocam2, " ".join(_nocam2))
