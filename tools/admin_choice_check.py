...
# ⚠️ 2026-08-27 손님: "관리자 페이지에 안쓰는 메뉴 다 없애."
#    script.yml(옛 12분 롱폼 길)을 뺐다. 2026-08-23 에 접은 길인데 메뉴에
#    남아 있었고 series.yml 과 번호까지 '2.' 로 겹쳐 헷갈렸다.
#    ⚠️ 메뉴를 뺄 때는 **이 목록도 같이** 손봐야 한다 (짝이다).
# ⚠️⚠️ 2026-08-27 — 손님: "쓸데 없는 기능들 다 지워."
#    지금 절차는 **90초 한 편** 하나다. 16화 길(대본·영상·모으기)은 감췄으므로
#    여기서도 그것들을 요구하면 안 된다 — 요구하면 감추는 것 자체가 막힌다.
#    (감춘 단추가 성한지는 check_admin 이 SIMPLE 을 꺼서 그려 보며 확인한다)
MUST_SHOW = {
    "keycheck.yml": "열쇠 점검 (돈 쓰기 전에 보는 자리)",
}
print()
