...
EPS = [
 ...
 dict(no=4, title="기각 당일", when="2013년 8월",
      ...
      leaves="남편이 내연녀 이름으로 재산을 넘기기 시작했다",
      reveal="남편이 기각 당일 내연녀 이름으로 재산을 넘기기 시작한다",
 ...
 dict(no=5, title="모르는 번호", when="2014년 봄",
      ...
      recap="남편이 내연녀 이름으로 재산을 넘겼다",
      because="남편이 내연녀 이름으로 재산을 넘기기 시작했다",
 ...
 dict(no=6, title="부인보다 내가 먼저", when="2016년 여름",
      ...
      yt_title="남편은 계약서에 아내보다 내연녀를 먼저 적었습니다",
      recap="아내는 남편 서류를 묻는 전화를 받았다",
      because="아내는 전화를 받았지만 아무것도 알아내지 못했다",
      leaves="내연녀가 남편에게 왜 죽는 얘기를 하냐고 물었다",
      reveal="병원 지분을 죽으면 내연녀에게 주는 특약에 서명한다",
      must=["특약"], irony=True,
      shots=["two", "ots", "close"],
      extras={3: [H]},
      cuts=[
 ...
 dict(no=7, title="새벽 전화", when="2017년 1월",
      ...
      recap="남편은 아내보다 내연녀를 먼저로 적었다",
      because="내연녀가 남편에게 왜 죽는 얘기를 하냐고 물었다",
