  ...
  { file: 'build-assets.yml', name: '2-2. 효과음·등장인물·배경 만들기',
    ...
    inputs: [{ k: 'what', label: '무엇을 만들까요', type: 'select',
               ...
               opts: [{ v: '기본 3가지 (효과음 + 등장인물 + 배경사진 · 약 399원)',
                      ...
                      // ⭐ 2026-08-13 — 구글이 그림을 막아 둔 동안 쓰는 버튼.
                      //    위의 [기본 3가지] 는 인물에서 반드시 실패 문구가 뜬다.
                      //    돈이 나가지도 않는데 그걸 보실 까닭이 없다.
                      { v: '소리 + 배경 사진만 (0원)',
                        t: '효과음 + 배경사진만 (0원 · 그림이 막혀 있을 때)' },
                      // ⭐ 2026-08-13 — 구글이 그림 만들기를 막아 두는 일이 실제로
                      //    생겼다(하루 한도 0). 그때 [기본 3가지] 를 누르면 소리·배경만
                      //    되고 인물은 한 장도 안 나온다. 값이 나가기 전에 **먼저
                      //    물어볼 수 있는 버튼**을 화면에 같이 둔다 (막혀 있으면 0원).
