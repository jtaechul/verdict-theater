...
const WORKFLOWS = [
  ...
  { file: 'build-assets.yml', name: '0. 등장인물·배경 그림 만들기', rare: true,
    desc: '등장인물 7명을 애니 그림으로 만듭니다 (약 399원). 영상 만들기가 알아서도 하지만, 그림만 먼저 보고 싶을 때 여기서 누르십시오',
    inputs: [{ k: 'what', label: '무엇을 만들까요', type: 'select',
               help: '효과음은 값이 들지 않습니다. 그림은 한 장씩 값이 듭니다.',
               opts: [{ v: '전부 다 만들기 (빠진 것만 · 인물 약 399원 · 나머지 0원)',
                        t: '전부 다 만들기 — 빠진 것만 (약 399원)' },
                      { v: '소리 (비용 0원)', t: '효과음 (0원)' },
