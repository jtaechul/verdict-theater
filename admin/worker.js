...
const WORKFLOWS = [
  ...
  { file: 'build-assets.yml', name: '2-2. 효과음·등장인물·배경 만들기',
    ...
    inputs: [{ k: 'what', label: '무엇을 만들까요', type: 'select',
               ...
               opts: [{ v: '기본 3가지 (효과음 + 등장인물 + 배경사진 · 약 399원)',
                      ...
                      // ⭐ 2026-08-13 — **여기에 이게 없어서 손님이 못 눌렀다.**
                      //    워크플로에는 만들어 놓고 관리자 페이지에 안 넣었다.
                      //    화면에 없는 버튼은 없는 기능이나 같다. 맨 위에 둔다.
                      //    (지금 있는 시트 7장이 전부 1MP 라 흐리다. 4K 로 다시
                      //     만들면 16.9MP — 없는 것만 만드는 버튼으로는 안 바뀐다)
                      // ⭐ 2026-08-14 — 새 프롬프트는 반드시 1장으로 먼저 확인한다.
                      //    어제 7장을 한꺼번에 뽑았다가 7장 다 못 쓰게 됐다.
                      { v: '시범 1장만 (M70 얼굴+상반신 · 약 265원)',
                        t: '시범 1장 — M70 얼굴·상반신 12장 (약 265원)' },
                      // 2026-08-14 — 얼굴 시트 합격. 같은 방식으로 전신 5자세.
                      { v: '시범 1장만 (M70 전신 · 약 265원)',
                        t: '시범 1장 — M70 전신 5자세 (약 265원)' },
                      { v: '망가진 배우 2명만 (F70·M50B · 4장 · 약 1,060원)',
                        t: '망가진 배우 2명만 다시 (F70·M50B — 이번 회차에 필요한 최소 · 약 1,060원)' },
                      { v: '남은 배우 6명 (M70 빼고 · 12장 · 약 3,180원)',
                        t: '남은 배우 6명 새로 만들기 — M70 은 확인 끝나서 건드리지 않음 (약 3,180원)' },
                      { v: '캐릭터 전부 다시 만들기 (M70 포함 14장 · 약 3,710원)',
                        t: '배우 7명 전부 새로 만들기 — M70 까지 다시 그림 (약 3,710원)' },
                      { v: '소리 + 배경 사진만 (0원)',
                        t: '효과음 + 배경사진만 (0원)' },
  ...
  { file: 'produce.yml', name: '3. 영상 만들기',
    ...
    inputs: [{ k: 'art', label: '빠진 그림을 만들까요', type: 'select',
