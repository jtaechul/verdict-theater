...
# ⚠️ 20 으로 뒀더니 이런 것들이 1~3음절 차이로 걸렸다:
#      "뭐라고요? 그이가 남긴 빚이 칠억이라고요?"          17음절 · 3.1초
#      "여긴 내 남편 장례식이야. 넌 낄 자리가 아니라고."   19음절 · 3.5초
#    셋 다 멀쩡한 드라마 대사다. 바닥이 하는 일과 목표가 하는 일을 내가
#    헷갈렸다 — **바닥은 '거의 빈 컷'만 막으면 되고**, 길이를 끌어올리는 것은
#    프롬프트의 목표치(24~28음절)가 할 일이다. 6초의 절반은 말하도록 16 으로.
DIA_SYL_MIN = 16       # 이보다 적으면 화면이 빈다 (16음절 ≈ 2.9초 = 6초의 절반)
